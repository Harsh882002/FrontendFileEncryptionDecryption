...
function FileUpload() {
  ...
  const handleEncrypt = async () => {
    ...
    try {
      const response = await fetch("https://encrydecry.onrender.com/file-encryption/encrypt", {
        method: "POST",
        body: formData,
      });
  ...
  const handleDecrypt = async () => {
    ...
    try {
      const response = await fetch("https://encrydecry.onrender.com/file-encryption/decrypt", {
        method: "POST",
        body: formData,
      });
